...
BUNDLED_SEMANTIC_RESOURCES = (
    ...
    ("RES-BUNDLED-CLUSTER-TRAIN", "training_samples", "内置深度聚类训练样本", "project://rules/deep_clustering/gold/anchor_gold_current.json", "zh"),
    ("RES-BUNDLED-CLUSTER-GOLD", "manually_labeled_category_data", "内置深度聚类人工标注类目标签数据", "project://rules/deep_clustering/gold/anchor_gold_current.json", "zh"),
)
