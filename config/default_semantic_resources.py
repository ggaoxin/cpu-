...
BUNDLED_SEMANTIC_RESOURCES = (
    ...
    ("RES-BUNDLED-CLUSTER-TRAIN", "training_samples", "内置深度聚类评测文本（1000篇）", "project://rules/deep_clustering/v7_reference/gold/gold_zh_model_reviewed_round3_1000.json", "zh"),
    ("RES-BUNDLED-CLUSTER-GOLD", "manually_labeled_category_data", "内置深度聚类人工标注答案（1000篇）", "project://rules/deep_clustering/v7_reference/gold/gold_zh_model_reviewed_round3_1000.json", "zh"),
)
