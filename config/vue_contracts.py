...
CONTRACTS = (
    ...
    _contract("zh-classify", "text batch-text file batch", "chinese_scientific_document_text document_title clc_labeled_data", "is_interdisciplinary classifications domain_labels", "chinese_scientific_document_text"),
    _contract("en-classify", "text batch-text file batch", "english_scientific_document_text document_title clc_labeled_data", "is_interdisciplinary classifications cross_language_mapping domain_labels literature_distribution_analysis_report", "english_scientific_document_text"),
    _contract("domain-classify", "text batch-text file batch", "domain_scientific_literature_data document_title professional_domain domain_classification_rules manually_labeled_training_data", "professional_domain multilevel_classification_results classification_confidence domain_labels", "domain_scientific_literature_data"),
    ...
    _contract("deep-cluster", "batch-text batch", "scientific_document_texts document_metadata cluster_dimension clustering_algorithm_type cluster_count output_format", "cluster_dimension_name input_summary clustering_quality clusters document_assignments semantic_projection theme_trend_analysis", "scientific_document_texts"),
